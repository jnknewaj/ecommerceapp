    ...
    return _then(_value.copyWith(
      ...
      sellerProfilePhoto: sellerProfilePhoto == freezed
          ...
          : sellerProfilePhoto // ignore: cast_nullable_to_non_nullable
              as String,
      sellerCoverPhoto: sellerCoverPhoto == freezed
          ? _value.sellerCoverPhoto
          : sellerCoverPhoto // ignore: cast_nullable_to_non_nullable
              as String,
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _Product &&
            ...
            (identical(other.sellerCoverPhoto, sellerCoverPhoto) ||
                const DeepCollectionEquality()
                    .equals(other.sellerCoverPhoto, sellerCoverPhoto)) &&
