...
/// @nodoc
class _$SellerResponseTearOff {
  const _$SellerResponseTearOff();

  _SellerResponse call({required List<Seller> sellers}) {
    return _SellerResponse(
      sellers: sellers,
    );
  }
}
...
/// @nodoc
const $SellerResponse = _$SellerResponseTearOff();
...
abstract class $SellerResponseCopyWith<$Res> {
  factory $SellerResponseCopyWith(
      ...
      _$SellerResponseCopyWithImpl<$Res>;
  $Res call({List<Seller> sellers});
}

/// @nodoc
class _$SellerResponseCopyWithImpl<$Res>
    implements $SellerResponseCopyWith<$Res> {
  _$SellerResponseCopyWithImpl(this._value, this._then);

  final SellerResponse _value;
  // ignore: unused_field
  final $Res Function(SellerResponse) _then;
...
/// @nodoc
abstract class _$SellerResponseCopyWith<$Res>
    implements $SellerResponseCopyWith<$Res> {
  factory _$SellerResponseCopyWith(
          _SellerResponse value, $Res Function(_SellerResponse) then) =
      __$SellerResponseCopyWithImpl<$Res>;
  @override
  $Res call({List<Seller> sellers});
}

/// @nodoc
class __$SellerResponseCopyWithImpl<$Res>
    extends _$SellerResponseCopyWithImpl<$Res>
    implements _$SellerResponseCopyWith<$Res> {
  __$SellerResponseCopyWithImpl(
      _SellerResponse _value, $Res Function(_SellerResponse) _then)
      : super(_value, (v) => _then(v as _SellerResponse));

  @override
  _SellerResponse get _value => super._value as _SellerResponse;

  @override
  $Res call({
    Object? sellers = freezed,
  }) {
    return _then(_SellerResponse(
      sellers: sellers == freezed
          ? _value.sellers
          : sellers // ignore: cast_nullable_to_non_nullable
              as List<Seller>,
...
class _$_SellerResponse implements _SellerResponse {
  const _$_SellerResponse({required this.sellers});
  ...
  @override
  String toString() {
    return 'SellerResponse(sellers: $sellers)';
  }

  @override
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other is _SellerResponse &&
  ...
  @JsonKey(ignore: true)
  @override
  _$SellerResponseCopyWith<_SellerResponse> get copyWith =>
      __$SellerResponseCopyWithImpl<_SellerResponse>(this, _$identity);
}

abstract class _SellerResponse implements SellerResponse {
  const factory _SellerResponse({required List<Seller> sellers}) =
      _$_SellerResponse;
...
abstract class _Seller implements Seller {
  const factory _Seller(
      ...
      required int highestDiscountPercent,
      required String lastAddToCart,
      required String lastAddToCartThatSold}) = _$_Seller;
